    ...
    class GenerateBenchmarkMenu:
        ...
        def Benchmark(self):
            try:
                ...
                InfoFont8 = DataFont.render("During the time the benchmark is running the window may appear unresponsive, don't worry this can be expected.", self.aa, self.FontCol)
