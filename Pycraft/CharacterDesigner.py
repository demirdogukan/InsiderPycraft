    ...
    class GenerateCharacterDesigner:
        ...
        def CharacterDesigner(self):
            try:
                ...
                CharacterDesignerFont = InfoTitleFont.render("Character Designer", self.aa, self.SecondFontCol)
                tempFPS = self.FPS
                ...
                while True:
                    ...
                    self.Display.blit(CharacterDesignerFont, (((realWidth-TitleWidth)/2)+55, 50))
                    ...
                    if not self.ErrorMessage == None:
                        self.ErrorMessage = "CharacterDesigner > GenerateCharacterDesigner > CharacterDesigner: "+str(self.ErrorMessage)
                        return
                    
            except Exception as Message:
                self.ErrorMessage = "CharacterDesigner > GenerateCharacterDesigner > CharacterDesigner: "+str(Message)
else:
