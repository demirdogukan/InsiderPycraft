        ...
        def Credits(self):
            try:
                ...
                while True:
                    ...
                    self.Display.fill(self.BackgroundCol)
                    self.Display.blit(Credits1, ((self.realWidth-Credits1Width)/2, 0+VisualYdisplacement))
                    self.Display.blit(Credits2, ((self.realWidth-Credits2Width)/2, 115+VisualYdisplacement))
                    self.Display.blit(Credits3, ((self.realWidth-Credits3Width)/2, (115*2)+VisualYdisplacement))
                    self.Display.blit(Credits4, ((self.realWidth-Credits4Width)/2, (115*3)+VisualYdisplacement))
                    self.Display.blit(Credits5, ((self.realWidth-Credits5Width)/2, (115*3)+20+VisualYdisplacement))
                    self.Display.blit(Credits6, ((self.realWidth-Credits6Width)/2, (115*3)+40+VisualYdisplacement))
                    self.Display.blit(Credits7, ((self.realWidth-Credits7Width)/2, (115*3)+60+VisualYdisplacement))
                    self.Display.blit(Credits8, ((self.realWidth-Credits8Width)/2, 540+VisualYdisplacement))
                    self.Display.blit(Credits9, ((self.realWidth-Credits9Width)/2, 540+20+VisualYdisplacement))
                    self.Display.blit(Credits10, ((self.realWidth-Credits10Width)/2, 540+40+VisualYdisplacement))
                    self.Display.blit(Credits11, ((self.realWidth-Credits11Width)/2, 540+60+VisualYdisplacement))
                    self.Display.blit(Credits12, ((self.realWidth-Credits12Width)/2, 540+80+VisualYdisplacement))
                    self.Display.blit(Credits13, ((self.realWidth-Credits13Width)/2, 540+100+VisualYdisplacement))
                    self.Display.blit(Credits14, ((self.realWidth-Credits14Width)/2, 540+120+VisualYdisplacement))
                    self.Display.blit(Credits15, ((self.realWidth-Credits15Width)/2, 540+140+VisualYdisplacement))
                    self.Display.blit(Credits16, ((self.realWidth-Credits16Width)/2, 540+160+VisualYdisplacement))
                    self.Display.blit(Credits17, ((self.realWidth-Credits17Width)/2, 540+180+VisualYdisplacement))
                    self.Display.blit(Credits18, ((self.realWidth-Credits18Width)/2, 540+200+VisualYdisplacement))
                    self.Display.blit(Credits19, ((self.realWidth-Credits19Width)/2, 540+220+VisualYdisplacement))
                    self.Display.blit(Credits20, ((self.realWidth-Credits20Width)/2, 540+240+VisualYdisplacement))
                    self.Display.blit(Credits21, ((self.realWidth-Credits21Width)/2, 540+260+VisualYdisplacement))
                    self.Display.blit(Credits22, ((self.realWidth-Credits22Width)/2, 915+VisualYdisplacement))
                    self.Display.blit(Credits23, ((self.realWidth-Credits23Width)/2, 935+VisualYdisplacement))
                    self.Display.blit(Credits24, ((self.realWidth-Credits24Width)/2, 1050+VisualYdisplacement))
                    self.Display.blit(Credits25, ((self.realWidth-Credits25Width)/2, 1165+VisualYdisplacement))
                    self.Display.blit(Credits26, ((self.realWidth-Credits26Width)/2, 1167+15+VisualYdisplacement))
                    self.Display.blit(Credits27, ((self.realWidth-Credits27Width)/2, 1167+30+VisualYdisplacement))
                    self.Display.blit(Credits28, ((self.realWidth-Credits28Width)/2, 1167+45+VisualYdisplacement))
                    self.Display.blit(Credits29, ((self.realWidth-Credits29Width)/2, 1167+60+VisualYdisplacement))
                    self.Display.blit(Credits30, ((self.realWidth-Credits30Width)/2, 1167+75+VisualYdisplacement))
                    self.Display.blit(Credits31, ((self.realWidth-Credits31Width)/2, 1167+90+VisualYdisplacement))
                    self.Display.blit(Credits32, ((self.realWidth-Credits32Width)/2, 1167+105+VisualYdisplacement))
                    self.Display.blit(Credits33, ((self.realWidth-Credits33Width)/2, 1167+120+VisualYdisplacement))
                    ...
                    if timer >= 1:
                        ...
                        if IntroYDisplacement <= 0:
                            ...
                            if int(1402+VisualYdisplacement) <= int(self.realHeight/2):
                                self.Display.blit(Credits34, ((self.realWidth-Credits34Width)/2, (self.realHeight-Credits34Height)/2))
                                ...
                                self.Display.blit(Credits34, ((self.realWidth-Credits34Width)/2, 1402+VisualYdisplacement))
                                VisualYdisplacement -= 60/(self.aFPS/self.Iteration)
                        else:
