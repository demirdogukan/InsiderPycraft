        ...
        def __init__(self, **kwargs):
            try:
                ...
                while True:
                    ...
                    SharedData.X = round(float(str(cam[3][0])), 2)
                    SharedData.Y = round(float(str(cam[3][1])), 2)
                    SharedData.Z = round(float(str(cam[3][3])), 2)
        ...
        def Play(self):
            try:
                ...
                try:
                    ...
                    print("GameEngine > CreateEngine > Play: "+str(Message))
